...
export interface PageError {
    type: "console" | "network" | "exception" | "crash" | "unhandled-rejection" | "invariant-violation";
    message: string;
    url?: string;
    stack?: string;
    timestamp: number;
...
export declare const NETWORK_PROFILES: readonly ["slow-3g", "fast-3g", "offline"];
/** Keys of PerformanceMetrics that a budget can target. */
export declare const PERF_BUDGET_KEYS: readonly ["ttfb", "fcp", "lcp", "tbt", "domContentLoaded", "load"];
