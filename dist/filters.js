...
export function matchesAnyPattern(value, patterns, flags) {
...
export function matchesSpaPattern(url, patterns) {
    if (!patterns)
        return null;
    for (const pattern of patterns) {
        try {
...
export function summarizePages(results, discovery) {
