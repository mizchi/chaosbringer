...
State3 ==
  log
      = <<
        [kind |-> "start", op |-> "-"], [kind |-> "rejectBody",
          op |-> "shipping"], [kind |-> "reject", op |-> "cart"]
      >>
    /\ opState
      = SetAsFun({ <<"cart", "rejected">>, <<"shipping", "bodyRejected">> })
    /\ ui = "error"
    /\ unhandled = FALSE

(* The following formula holds true in the last state and violates the invariant *)
InvariantViolation ==
  opState["cart"] = "rejected" /\ opState["shipping"] = "bodyRejected"

================================================================================
(* Created by Apalache on Thu Aug 20 11:13:27 UTC 2026 *)
